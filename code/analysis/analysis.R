...
gini_3 <- lm(gini_std ~ Remittance_as_percent + I(Remittance_as_percent^2) + 
               school_13+ I(school_13^2) + school_58 + I(school_58^2) + 
               Real.GDP + GDP.per.capita + Total.investment + 
               Unemployment.rate + General.government.total.expenditure, 
             data = df)

share_3 <- lm(I(top20 - bottom20) ~ Remittance_as_percent + I(Remittance_as_percent^2) + 
                school_13+ I(school_13^2) + school_58 + I(school_58^2) + 
                Real.GDP + GDP.per.capita + Total.investment + 
                Unemployment.rate + General.government.total.expenditure,
              data = df)
...
gini_4 <- feols(gini_std ~ Remittance_as_percent + I(Remittance_as_percent^2) + 
                  school_13 + I(school_13^2) + school_58 + I(school_58^2) + 
                  Real.GDP + GDP.per.capita + Total.investment + 
                  Gross.national.savings + Inflation + Unemployment.rate + 
                  General.government.total.expenditure + 
...
share_4 <- feols(I(top20 - bottom20) ~ Remittance_as_percent + I(Remittance_as_percent^2) + 
                   school_13 + I(school_13^2) + school_58 + I(school_58^2) + 
                   Real.GDP + GDP.per.capita + Total.investment + 
                   Gross.national.savings + Inflation + Unemployment.rate + 
                   General.government.total.expenditure + 
